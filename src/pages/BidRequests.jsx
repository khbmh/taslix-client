    ...
    <section className="container px-4 mx-auto my-12">
      ...
      <div className="flex flex-col mt-6">
        <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-10">
                ...
                <tbody className="bg-white divide-y divide-gray-200 ">
                  {bids.map((bid) => (
                    <tr key={bid._id}>
                      ...
                      <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">
                        {format(new Date(bid.deliveryDate), 'PP')}
                      </td>
                      <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">
                        ${bid.price}
                      </td>
                      ...
                      <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                        ...
                        >
                          ...
                          ${bid.status === 'Completed' && ' bg-blue-500'}
                      ...
                      <td className="px-4 py-4 text-sm whitespace-nowrap">
                        <div className="flex items-center gap-x-6">
                          ...
                          <button
                            ...
                            className="disabled:cursor-not-allowed text-gray-800 transition-colors duration-200 hover:text-green-500 focus:outline-none"
                          >
                            <svg
                          ...
                          <button
                            ...
                            className="disabled:cursor-not-allowed text-gray-800 transition-colors duration-200 hover:text-red-500 focus:outline-none"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
